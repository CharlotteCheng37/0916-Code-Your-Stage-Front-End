...
function Tooltip({ children, className, bg, size, position }) {
  ...
  return (
    <div
      ...
      onMouseEnter={() => setTooltipOpen(true)} // 鼠标进入时显示提示框
      onMouseLeave={() => setTooltipOpen(false)} // 鼠标离开时隐藏提示框
      onFocus={() => setTooltipOpen(true)} // 获得焦点时显示提示框
      onBlur={() => setTooltipOpen(false)} // 失去焦点时隐藏提示框
    >
      <button
        className="block"
        aria-haspopup="true"
